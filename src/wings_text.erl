...
%%
%%     $Id: wings_text.erl,v 1.6 2002/02/14 17:46:41 bjorng Exp $
%%
...
char(caret) ->
    B = <<
	 ...
	 2#11000000
	 >>,
    gl:bitmap(2, 14, 0.0, 2.0, 2.0, 0.0, B);
...
char(252) ->
 ...
 gl:bitmap(6, 9, -1.0, 0.0, 7.0, 0.0, B);

% char: 0xfb

char(251) ->
 B = <<16#74,16#8c,16#84,16#84,16#84,16#84,16#84,16#0,16#48,16#30>>,
 gl:bitmap(6, 10, -1.0, 0.0, 7.0, 0.0, B);
...
char(247) ->
 ...
 gl:bitmap(6, 5, 0.0, 0.0, 7.0, 0.0, B);
...
char(243) ->
 ...
 gl:bitmap(6, 11, -1.0, 0.0, 7.0, 0.0, B);
...
char(231) ->
 ...
 gl:bitmap(6, 9, -1.0, 2.0, 7.0, 0.0, B);

% char: 0xe6

char(230) ->
 B = <<16#7c,16#92,16#90,16#5e,16#32,16#92,16#7c>>,
 gl:bitmap(7, 7, 0.0, 0.0, 7.0, 0.0, B);
...
char(221) ->
 ...
 gl:bitmap(6, 12, -1.0, 0.0, 7.0, 0.0, B);
...
char(216) ->
 ...
 gl:bitmap(6, 14, -1.0, 2.0, 7.0, 0.0, B);
...
char(208) ->
 ...
 gl:bitmap(7, 10, 0.0, 0.0, 7.0, 0.0, B);
...
char(206) ->
 ...
 gl:bitmap(5, 12, -2.0, 0.0, 7.0, 0.0, B);
...
char(187) ->
 ...
 gl:bitmap(6, 7, -1.0, 0.0, 7.0, 0.0, B);

% char: 0xba

char(186) ->
 B = <<16#f0,16#0,16#60,16#90,16#90,16#60>>,
 gl:bitmap(4, 6, -2.0, -4.0, 7.0, 0.0, B);

% char: 0xb9

char(185) ->
 B = <<16#40,16#40,16#40,16#40,16#c0,16#40>>,
 gl:bitmap(2, 6, -1.0, -4.0, 7.0, 0.0, B);

% char: 0xb8

char(184) ->
 B = <<16#80,16#40,16#40>>,
 gl:bitmap(2, 3, -2.0, 2.0, 7.0, 0.0, B);

% char: 0xb7

char(183) ->
 B = <<16#80>>,
 gl:bitmap(1, 1, -3.0, -5.0, 7.0, 0.0, B);

% char: 0xb6

char(182) ->
 B = <<16#38,16#28,16#28,16#28,16#28,16#28,16#68,16#a8,16#a8,16#a8,16#a8,16#78>>,
 gl:bitmap(5, 12, -1.0, 2.0, 7.0, 0.0, B);

% char: 0xb5

char(181) ->
 B = <<16#80,16#80,16#a8,16#d8,16#88,16#88,16#88,16#88>>,
 gl:bitmap(5, 8, -1.0, 2.0, 7.0, 0.0, B);

% char: 0xb4

char(180) ->
 B = <<16#80,16#40,16#20,16#10>>,
 gl:bitmap(4, 4, -1.0, -7.0, 7.0, 0.0, B);

% char: 0xb3

char(179) ->
 B = <<16#60,16#90,16#10,16#60,16#10,16#90,16#60>>,
 gl:bitmap(4, 7, -1.0, -4.0, 7.0, 0.0, B);
...
char(177) ->
 ...
 gl:bitmap(5, 6, -1.0, 0.0, 7.0, 0.0, B);
...
char(175) ->
 B = <<16#f0>>,
 gl:bitmap(4, 1, 0.0, -9.0, 7.0, 0.0, B);
...
char(173) ->
 B = <<16#f0>>,
 gl:bitmap(4, 1, 0.0, -3.0, 7.0, 0.0, B);

% char: 0xac

char(172) ->
 B = <<16#8,16#8,16#8,16#f8>>,
 gl:bitmap(5, 4, 0.0, 0.0, 7.0, 0.0, B);
...
char(170) ->
 ...
 gl:bitmap(5, 8, -2.0, -3.0, 7.0, 0.0, B);
...
char(168) ->
 B = <<16#90,16#90>>,
 gl:bitmap(4, 2, -1.0, -9.0, 7.0, 0.0, B);
...
char(166) ->
 ...
 gl:bitmap(1, 10, -3.0, 0.0, 7.0, 0.0, B);
...
char(119) ->
 ...
 gl:bitmap(5, 7, -1.0, 0.0, 7.0, 0.0, B);
...
char(96) ->
 ...
 gl:bitmap(2, 4, -4.0, -7.0, 7.0, 0.0, B);

% char: 0x5f '_' */

char(95) ->
 B = <<16#fc>>,
 gl:bitmap(6, 1, -1.0, 2.0, 7.0, 0.0, B);

% char: 0x5e '^' */

char(94) ->
 B = <<16#84,16#48,16#30>>,
 gl:bitmap(6, 3, -1.0, -8.0, 7.0, 0.0, B);
...
char(92) ->
 ...
 gl:bitmap(6, 13, -1.0, 2.0, 7.0, 0.0, B);
...
char(89) ->
 ...
 gl:bitmap(5, 10, -1.0, 0.0, 7.0, 0.0, B);
...
char(61) ->
 ...
 gl:bitmap(6, 4, -1.0, -3.0, 7.0, 0.0, B);
...
char(59) ->
 ...
 gl:bitmap(2, 8, -3.0, 1.0, 7.0, 0.0, B);

% char: 0x3a ':' */

char(58) ->
 B = <<16#40,16#e0,16#40,16#0,16#0,16#40,16#e0,16#40>>,
 gl:bitmap(3, 8, -3.0, 0.0, 7.0, 0.0, B);
...
char(46) ->
 B = <<16#40,16#e0,16#40>>,
 gl:bitmap(3, 3, -3.0, 1.0, 7.0, 0.0, B);

% char: 0x2d '-' */

char(45) ->
 B = <<16#fc>>,
 gl:bitmap(6, 1, -1.0, -4.0, 7.0, 0.0, B);

% char: 0x2c ',' */

char(44) ->
 B = <<16#80,16#40,16#40,16#c0>>,
 gl:bitmap(2, 4, -2.0, 2.0, 7.0, 0.0, B);

% char: 0x2b '+' */

char(43) ->
 B = <<16#20,16#20,16#20,16#f8,16#20,16#20,16#20>>,
 gl:bitmap(5, 7, -1.0, -1.0, 7.0, 0.0, B);

% char: 0x2a '*' */

char(42) ->
 B = <<16#20,16#a8,16#70,16#20,16#70,16#a8,16#20>>,
 gl:bitmap(5, 7, -2.0, -3.0, 7.0, 0.0, B);
...
char(39) ->
 B = <<16#80,16#40,16#40,16#c0>>,
 gl:bitmap(2, 4, -3.0, -7.0, 7.0, 0.0, B);
...
char(36) ->
 ...
 gl:bitmap(6, 11, -1.0, 1.0, 7.0, 0.0, B);
...
char(34) ->
 ...
 gl:bitmap(5, 4, -1.0, -7.0, 7.0, 0.0, B);
